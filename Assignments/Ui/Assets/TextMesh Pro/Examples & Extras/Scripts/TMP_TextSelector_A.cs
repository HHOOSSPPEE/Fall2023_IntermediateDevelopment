        ...
        void LateUpdate()
        {
            ...
            if (m_isHoveringObject)
            {
                ...
                if (charIndex != -1 && charIndex != m_lastCharIndex && (Input.GetKey(KeyCode.LeftShift) || Input.GetKey(KeyCode.RightShift)))
                {
                    ...
                    UnityEngine.Color32 c = new UnityEngine.Color32((byte)Random.Range(0, 255), (byte)Random.Range(0, 255), (byte)Random.Range(0, 255), 255);
                ...
                if (wordIndex != -1 && wordIndex != m_lastWordIndex)
                {
                    ...
                    UnityEngine.Color32[] vertexColors = m_TextMeshPro.textInfo.meshInfo[0].colors32;
