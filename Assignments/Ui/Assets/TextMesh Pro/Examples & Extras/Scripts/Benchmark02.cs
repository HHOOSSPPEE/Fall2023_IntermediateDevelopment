        ...
        void Start()
        {
            ...
            for (int i = 0; i < NumberOfNPC; i++)
            {
                ...
                if (SpawnType == 0)
                {
                    ...
                    textMeshPro.color = new UnityEngine.Color32(255, 255, 0, 255);
                    textMeshPro.text = "!";
                ...
                else if (SpawnType == 1)
                {
                    ...
                    textMesh.color = new UnityEngine.Color32(255, 255, 0, 255);
                    textMesh.text = "!";
                ...
                else if (SpawnType == 2)
                {
                    ...
                    textObject.color = new UnityEngine.Color32(255, 255, 0, 255);
