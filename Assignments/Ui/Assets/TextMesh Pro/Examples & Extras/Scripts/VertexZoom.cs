        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    UnityEngine.Color32[] sourceColors32 = cachedMeshInfoVertexData[materialIndex].colors32;
                    UnityEngine.Color32[] destinationColors32 = textInfo.meshInfo[materialIndex].colors32;
