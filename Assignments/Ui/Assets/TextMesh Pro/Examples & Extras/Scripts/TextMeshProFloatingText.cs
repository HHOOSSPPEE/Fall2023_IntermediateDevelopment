    ...
    public class TextMeshProFloatingText : MonoBehaviour
    {
        ...
        void Start()
        {
            if (SpawnType == 0)
            {
                ...
                m_textMeshPro.color = new UnityEngine.Color32((byte)Random.Range(0, 255), (byte)Random.Range(0, 255), (byte)Random.Range(0, 255), 255);
            ...
            else if (SpawnType == 1)
            {
                ...
                m_textMesh.color = new UnityEngine.Color32((byte)Random.Range(0, 255), (byte)Random.Range(0, 255), (byte)Random.Range(0, 255), 255);
        ...
        public IEnumerator DisplayTextMeshProFloatingText()
        {
            ...
            UnityEngine.Color32 start_color = m_textMeshPro.color;
            float alpha = 255;
            int int_counter = 0;
            ...
            while (current_Count > 0)
            {
                ...
                m_textMeshPro.color = new UnityEngine.Color32(start_color.r, start_color.g, start_color.b, (byte)alpha);
        ...
        public IEnumerator DisplayTextMeshFloatingText()
        {
            ...
            Vector3 start_pos = m_floatingText_Transform.position;
            UnityEngine.Color32 start_color = m_textMesh.color;
            float alpha = 255;
            int int_counter = 0;
            ...
            while (current_Count > 0)
            {
                ...
                m_textMesh.color = new UnityEngine.Color32(start_color.r, start_color.g, start_color.b, (byte)alpha);
