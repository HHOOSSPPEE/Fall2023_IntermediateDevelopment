mergeInto(LibraryManager.library, {
  ...
  HISPLAYERUnity_EventAsyncCmdType: function () {
    return getEventAsyncCMDType();
  },

  HISPLAYERUnity_EventAsyncCmdValue: function() {
    return getEventAsyncCMDValue();
  },

  HISPLAYERUnity_EventAsyncCmdResult: function () {
    return getEventAsyncCMDResult();
  },

  HISPLAYERUnity_EventAsyncCmdPlayerIndex: function() {
    return HISPLAYERUnity_EventAsyncCmdPlayerIndex();
  },
  ...
  HISPLAYERUnity_ErrorAsyncCmdType: function () {
    return getErrorAsyncCMDType();
  },

  HISPLAYERUnity_ErrorAsyncCmdValue: function() {
    return getErrorAsyncCMDValue();
  },

  HISPLAYERUnity_ErrorAsyncCmdResult: function () {
    return getErrorAsyncCMDResult();
  },

  HISPLAYERUnity_ErrorAsyncCmdPlayerIndex: function() {
    return HISPLAYERUnity_ErrorAsyncCmdPlayerIndex();
  },
